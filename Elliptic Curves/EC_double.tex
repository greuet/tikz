...
\begin{tikzpicture}[xscale=0.7]
  \begin{axis}[grid = major, hide axis]
    ...
    \node[anchor = south east] at (axis cs: -1.1 , 1.3 ) {\resizebox{1.42857142857143ex}{1ex}{$P$}};
    \node[anchor = south east] at (axis cs: 2.8 , 4) {\resizebox{5.18ex}{1ex}{$-[2]P$}};
    \node[anchor = east] at (axis cs: 2.8 , -4.1) {\resizebox{3.5ex}{1ex}{$[2]P$}};
